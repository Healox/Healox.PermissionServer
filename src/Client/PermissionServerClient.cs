...
namespace Healox.PermissionServer.Client
{
    ...
    /// PolicyServer client
    /// </summary>
    public class PermissionServerClient : IPermissionServerClient
    {
        private readonly Policy _policy;

        /// <summary>
        /// Initializes a new instance of the <see cref="PermissionServerClient"/> class.
        /// </summary>
        /// <param name="policy">The policy.</param>
        public PermissionServerClient(Policy policy)
        {
            _policy = policy;
        }
