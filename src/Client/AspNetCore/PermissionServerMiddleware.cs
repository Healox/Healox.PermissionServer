...
namespace Healox.PermissionServer.Client.AspNetCore
{
    /// <summary>
    /// Middleware to automatically turn application roles and permissions into claims
    /// </summary>
    public class PermissionServerClaimsMiddleware
    {
        private readonly RequestDelegate _next;

        /// <summary>
        /// Initializes a new instance of the <see cref="PermissionServerClaimsMiddleware"/> class.
        /// </summary>
        /// <param name="next">The next.</param>
        public PermissionServerClaimsMiddleware(RequestDelegate next)
        {
            _next = next;
        }
        ...
        /// <returns></returns>
        public async Task Invoke(HttpContext context, IPermissionServerClient client)
        {
